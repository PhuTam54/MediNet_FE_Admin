...
import { getCourses, deleteCourses } from '~/services/Courses/courseService';
...
function Courses() {
    ...
    const handleDeleteConfirm = async () => {
        deleteCourses(deleteId)
            ...
            .catch((error) => {
                toast.error('Failed to delete Courses', error);
            });
    };
        ...
        <section className="section">
            <div className="section-header">
                ...
                <div className="section-header-breadcrumb">
                    ...
                    <div className="breadcrumb-item">All Courses</div>
                </div>
            </div>
