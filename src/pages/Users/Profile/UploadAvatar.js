...
const UpoloadAvatar = ({ userId, token, username, avatarUrl, setisUserUpdated }) => {
    ...
    return (
        <div>
            ...
            <Modal isOpen={modal} toggle={toggle}>
                <ModalHeader toggle={toggle}>{`${avatarUrl ? 'Change' : 'Upload'} your avatar`}</ModalHeader>
                <ModalBody>
                    <Form>
                        <FormGroup>
                            <Label for="exampleFile">File</Label>
                            <Input type="file" name="file" id="exampleFile" onChange={handleFileChange} />
                        </FormGroup>
                    </Form>
                </ModalBody>
                <ModalFooter>
